...
### NOT DOING THIS: localhost:8000/finches
...
urlpatterns = [
  ...
  # localhost:8000/finches/int:finch_id
  ...
  # localhost:8000/finches/int:finch_id/delete
  path('finches/<int:pk>/delete/', views.FinchDelete.as_view(), name='finches_delete'),
  # localhost:8000/finches/int:finch_id/add_feeding
